...
import eventHandlers.ResizeEventHandler;
...
public class ResizeAnchor extends Rectangle {
  ...
  private void mode(Cursor cursor, Rectangle rectangle) {
    MouseEventHandler resizeEventHandler = new ResizeEventHandler(this.paintController);
    this.setOnMousePressed(resizeEventHandler.getOnMousePressedEventHandler());
    this.setOnMouseDragged(resizeEventHandler.getOnMouseDraggedEventHandler());
    this.setOnMouseReleased(resizeEventHandler.getOnMouseReleasedEventHandler());
